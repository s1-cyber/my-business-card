...
function App() {
  ...
  const facts = [
    ...
    },
    {
      icon: <FaBrain />,
      title: "AI факт",
      text: "Первый компьютерный «баг» действительно был насекомым: в 1947 году мотылёк застрял в реле компьютера Harvard Mark II, и с тех пор слово “bug” стало означать ошибку в коде.",
    },
    {
      icon: <FaBrain />,
      title: "AI факт",
